...
import { createFilter, normalizePath as normalizePath$1, transformWithEsbuild, formatPostcssSourceMap, isCSSRequest, mergeConfig, searchForWorkspaceRoot } from 'vite';
